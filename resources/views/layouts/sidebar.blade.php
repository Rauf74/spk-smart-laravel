    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('profile') ? 'active' : '' }}" href="{{ route('profile') }}" aria-expanded="false">
                ...
                @if(Auth::user()->role === 'Guru BK')
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('subkriteria.index') ? 'active' : '' }}" href="{{ route('subkriteria.index') }}" aria-expanded="false">
                            <span><i class="ti ti-list-details"></i></span>
                            <span class="hide-menu">Data Subkriteria</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('alternatif.index') ? 'active' : '' }}" href="{{ route('alternatif.index') }}" aria-expanded="false">
                            <span><i class="ti ti-clipboard-list"></i></span>
                            <span class="hide-menu">Data Alternatif</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('pertanyaan.index') ? 'active' : '' }}" href="{{ route('pertanyaan.index') }}" aria-expanded="false">
                            <span><i class="ti ti-help"></i></span>
                            <span class="hide-menu">Data Pertanyaan</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('penilaian.index') ? 'active' : '' }}" href="{{ route('penilaian.index') }}" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('perhitungan.index') ? 'active' : '' }}" href="{{ route('perhitungan.index') }}" aria-expanded="false">
                            <span><i class="ti ti-calculator"></i></span>
                            <span class="hide-menu">Data Perhitungan</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('perangkingan.index') ? 'active' : '' }}" href="{{ route('perangkingan.index') }}" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('user.index') ? 'active' : '' }}" href="{{ route('user.index') }}" aria-expanded="false">
