...
class KriteriaSeeder extends Seeder
{
    public function run(): void
    {
        $kriterias = [
            ...
            ['id_kriteria' => 5, 'kode_kriteria' => 'K5', 'nama_kriteria' => 'Kemampuan Interpersonal dan Soft Skills', 'jenis' => 'Benefit', 'bobot' => 5.00],
            ['id_kriteria' => 22, 'kode_kriteria' => 'K6', 'nama_kriteria' => 'Tester K', 'jenis' => 'Cost', 'bobot' => 5.00],
        ];
